        ...
        <PaymentLinkContainerA>
           ...
           {!url ? (
                <PaymentLinkContainer theme={theme}>
                    ...
                    <Title theme={theme}>Make link/ Qr code payment with fixed amount to specific Paysphere user ⬆️ </Title>
                    <Input
                        theme={theme}
                        type="text"
...
export default PaymentLinkQrCode4;
