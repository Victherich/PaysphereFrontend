// ReceiveCardTapPayment.js

import React, { useContext } from 'react';
import styled from 'styled-components';
import { Context } from './Context';
import { FaCreditCard } from 'react-icons/fa'; // Icon for Card Tap Payment

const ReceiveCardTapPayment = () => {
    ...
    return (
        <PaymentContainerA>
            <PaymentContainer theme={theme}>
                ...
                <Title theme={theme}>Receive Card Tap Payment</Title>
...
export default ReceiveCardTapPayment;
