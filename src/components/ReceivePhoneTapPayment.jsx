// ReceivePhoneTapPayment.js

import React, { useContext } from 'react';
import styled from 'styled-components';
import { Context } from './Context';
import { FaMobileAlt } from 'react-icons/fa'; // Icon for Phone Tap Payment

const ReceivePhoneTapPayment = () => {
    ...
    return (
        <PaymentContainerA>
            <PaymentContainer theme={theme}>
                ...
                <Title theme={theme}>Receive Phone Tap Payment</Title>
...
export default ReceivePhoneTapPayment;
