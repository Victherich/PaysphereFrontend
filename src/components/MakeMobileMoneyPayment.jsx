...
import { FaMobileAlt } from 'react-icons/fa'; // Icon for USSD

const MakeMobileMoneyPayment = () => {
    ...
    return (
        <PaymentContainerA>
            <PaymentContainer theme={theme}>
                ...
                <Title theme={theme}>Make Mobile Money Payment</Title>
                <Input theme={theme} type="text" placeholder="Enter Amount" />
                <Input theme={theme} type="text" placeholder="Enter Your Phone" />
                <Input theme={theme} type="text" placeholder="Enter Recipient User ID" />
                <ButtonContainer>
...
export default MakeMobileMoneyPayment;
