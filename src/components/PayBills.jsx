...
const PayBills = () => {
  ...
  return (
    <PayBillsContainerA>
      <PayBillsContainer theme={theme}>
        <Icon theme={theme}>
          <FaFileInvoiceDollar />
        </Icon>
        <Title theme={theme}>Pay Bills</Title>
        <Input theme={theme} type="text" placeholder="Enter Bill Details" />
...
const PayBillsContainerA = styled.div`
  padding-top: 100px;
`;
...
const Icon = styled(FaFileInvoiceDollar)`
  font-size: 4rem;
