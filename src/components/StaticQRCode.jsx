...
const StaticQrCode = () => {
    ...
    return (
        <StaticQrCodeContainerA>
            <StaticQrCodeContainer theme={theme}>
                <Icon theme={theme}>
                    <FaQrcode />
                </Icon>
                <Title theme={theme}>Generate Static QR Code</Title>
                <Input theme={theme} type="text" placeholder="Enter Amount" />
                <ButtonContainer>
                    <Button primary theme={theme}>Generate QR Code</Button>
                    <Button onClick={() => setMenuSwitch(0)} theme={theme}>Cancel</Button>
                </ButtonContainer>
            </StaticQrCodeContainer>
        </StaticQrCodeContainerA>
    );
}
...
const StaticQrCodeContainerA = styled.div`
    padding-top: 100px;
`;

const StaticQrCodeContainer = styled.div`
    display: flex;
