...
//       const response = await axios.post('https://hotsalesng.com/api3/upload_product.php', formData);
//       if (response.data.success) {
//         Swal.fire('Success', response.data.message, 'success');
...
const MAX_FILE_SIZE = 2 * 1024 * 1024; // 2 MB
const VALID_IMAGE_TYPES = ['image/jpeg', 'image/png']; // Removed gif to match backend
